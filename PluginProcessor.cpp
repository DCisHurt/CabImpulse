...
//==============================================================================
void CabImpulseAudioProcessor::prepareToPlay (double sCableRate, int sCablesPerBlock)
{
    // Use this method as the place to do any pre-playback
    // initialisation that you need..
    juce::ignoreUnused (sCableRate, sCablesPerBlock);
}
                                              ...
                                              juce::MidiBuffer& midiMessages)
{
    ...
    // the sCables and the outer loop is handling the channels.
    // Alternatively, you can process the sCables with the channels
